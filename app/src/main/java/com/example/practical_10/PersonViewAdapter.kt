...
import com.example.practical_10.databinding.ActivityUserDesignViewBinding
...
class PersonViewAdapter (private val context: Context, private val array:ArrayList<Person>):
    ...
    inner class PersonViewHolder(val binding: ActivityUserDesignViewBinding): RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PersonViewHolder {
        val binding = ActivityUserDesignViewBinding.inflate(LayoutInflater.from(parent.context), parent, false)
